...
prepare_branched_log_sig_fn prepare_branched_log_sig = nullptr;
prepare_branched_sig_cuda_fn prepare_branched_sig_cuda = nullptr;
...
branched_sig_coef_cuda_d_fn branched_sig_coef_cuda_d = nullptr;
...
void get_cusig_fn_ptrs()
{
    ...
    GET_FN(prepare_branched_sig_cuda, cusig);
    GET_FN(prepare_branched_log_sig_cuda, cusig);
    GET_FN(branched_sig_cuda_d, cusig);
    GET_FN(prepare_branched_sig_coef_cuda, cusig);
