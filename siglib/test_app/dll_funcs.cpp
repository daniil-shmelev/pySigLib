...
prepare_volterra_sig_d_fn prepare_volterra_sig_d = nullptr;
prepare_volterra_sig_f_fn prepare_volterra_sig_f = nullptr;
free_volterra_sig_d_fn free_volterra_sig_d = nullptr;
free_volterra_sig_f_fn free_volterra_sig_f = nullptr;
volterra_sig_d_fn volterra_sig_d = nullptr;
volterra_sig_f_fn volterra_sig_f = nullptr;
...
void get_cpsig_fn_ptrs()
{
    ...
    GET_FN(prepare_volterra_sig_d, cpsig);
    GET_FN(prepare_volterra_sig_f, cpsig);
    GET_FN(free_volterra_sig_d, cpsig);
    GET_FN(free_volterra_sig_f, cpsig);
    GET_FN(volterra_sig_d, cpsig);
    GET_FN(volterra_sig_f, cpsig);
