...
using sig_kernel_poly_d_fn = int(CDECL_*)(const double*, double*, double*, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, bool, int);

using sig_kernel_poly_backprop_d_fn = int(CDECL_*)(const double*, double*, const double*, const double*, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, bool, int);

using sig_kernel_cuda_d_fn = int(CDECL_*)(const double*, double*, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, bool);

using sig_kernel_poly_cuda_f_fn = int(CDECL_*)(const float*, float*, float*, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, bool);
using sig_kernel_poly_cuda_d_fn = int(CDECL_*)(const double*, double*, double*, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, bool);
using sig_kernel_poly_backprop_cuda_f_fn = int(CDECL_*)(const float*, float*, const float*, const float*, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, bool);
using sig_kernel_poly_backprop_cuda_d_fn = int(CDECL_*)(const double*, double*, const double*, const double*, uint64_t, uint64_t, uint64_t, uint64_t, uint64_t, bool);
...
extern sig_kernel_poly_d_fn sig_kernel_poly_d;
extern sig_kernel_poly_backprop_d_fn sig_kernel_poly_backprop_d;
...
extern sig_kernel_poly_cuda_f_fn sig_kernel_poly_cuda_f;
extern sig_kernel_poly_cuda_d_fn sig_kernel_poly_cuda_d;
extern sig_kernel_poly_backprop_cuda_f_fn sig_kernel_poly_backprop_cuda_f;
extern sig_kernel_poly_backprop_cuda_d_fn sig_kernel_poly_backprop_cuda_d;
