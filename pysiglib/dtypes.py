...
CPSIG_PREPARE_VOLTERRA_SIG_GENERAL = {
    "float32": CPSIG.prepare_volterra_sig_general_f,
    "float64": CPSIG.prepare_volterra_sig_general_d
}

CPSIG_VOLTERRA_SIG_GENERAL = {
    "float32": CPSIG.volterra_sig_general_f,
    "float64": CPSIG.volterra_sig_general_d
}

CPSIG_FREE_VOLTERRA_SIG_GENERAL = {
    "float32": CPSIG.free_volterra_sig_general_f,
