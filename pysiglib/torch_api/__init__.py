...
class SigStream(_SigStream[torch.Tensor]):
    _array_type = torch.Tensor
    __doc__ = _backend_doc(_SigStream.__doc__, "torch")
...
class LogSigStream(_LogSigStream[torch.Tensor]):
    _array_type = torch.Tensor
    __doc__ = _backend_doc(_LogSigStream.__doc__, "torch")
...
class SigWindowStream(_SigWindowStream[torch.Tensor]):
    _array_type = torch.Tensor
    __doc__ = _backend_doc(_SigWindowStream.__doc__, "torch")
...
class LogSigWindowStream(_LogSigWindowStream[torch.Tensor]):
    _array_type = torch.Tensor
    __doc__ = _backend_doc(_LogSigWindowStream.__doc__, "torch")
...
extract_sig_coef.__doc__ = _backend_doc(
    _extract_sig_coef.extract_sig_coef.__doc__, "torch"
)
...
extract_branched_sig_coef.__doc__ = _backend_doc(
    _extract_branched_sig_coef.extract_branched_sig_coef.__doc__, "torch"
)
